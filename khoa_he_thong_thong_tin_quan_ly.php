...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        <div class="container">
            <!-- logo  -->
            <a class="navbar-brand" href="index.html" style="color: #CF111A;"><b>Nhà sách Học Viện Ngân Hàng</b></a>
                ...
                <div class="modal-body">
                    <form id="form-signup" class="form-signin mt-2">
                        ...
                        <div class="custom-control custom-checkbox">
                            <p class="text-center">Bằng việc đăng ký, bạn đã đồng ý với Về Nhà sách Học Viện Ngân Hàng về</p>
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="categoryheader">
                        ...
                        <div class="categorycontent">
                            ...
                            <li><a href="#">Khoa Luật </a><i class="fa fa-chevron-right float-right"></i>
                                
                            </li>
                            <li><a href="#">Khoa Kế- Kiểm</a><i class="fa fa-chevron-right float-right"></i>
                               
                            </li>
                            <li><a href="khoa_he_thong_thong_tin_quan_ly.php">Khoa Hệ Thống Thông Tin Quản Lý</a><i class="fa fa-chevron-right float-right"></i>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="khoa_he_thong_thong_tin_quan_ly.php">Khoa Hệ Thống Thông Tin Quản Lý</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.php"><img src="images/htttql.png" alt="htttql"
                    class="img-fluid"></a>
        </div>
    </section>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                ...
                <div >
                    ...
                    $sql = "
                              ...
                              WHERE ten_khoa=N'Khoa Hệ Thống Thông Tin Quản Lý'
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                <div class="card ">
                                    <a href="chi_tiet_sp.php" class="motsanpham"
                                        ...
                                        <img class="card-img-top anh" src="<?php echo $row['anh'] ? 'images/'.$row['anh'] : 'images/blog/tindaicuong.jpg';?>"
                                            alt="">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h6 class="header text-uppercase font-weight-bold">Về Nhà sách Học Viện Ngân Hàng</h6>
                        <a href="#">Giới thiệu về Về Nhà sách Học Viện Ngân Hàng</a>
                        <a href="#">Tuyển dụng</a>
