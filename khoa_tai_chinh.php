...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="khoa_tai_chinh.php">Khoa Tài Chính</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.php"><img src="images/taichinh.png" alt="taichinh"
                    class="img-fluid"></a>
        </div>
    </section>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                ...
                <div >
                    ...
                    $sql = "
                              ...
                              WHERE ten_khoa=N'Khoa Tài Chính '
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                <div class="card ">
                                    <a href="chi_tiet_sp.php" class="motsanpham"
                                        ...
                                        <img class="card-img-top anh" src="<?php echo $row['anh'] ? 'images/'.$row['anh'] : 'images/blog/phantichvadautuchungkhoan.jpg';?>"
                                            alt="">
