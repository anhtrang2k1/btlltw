...
<body>
    ...
    <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.php"><img src="images/toan.png" alt="toan"
                    class="img-fluid"></a>
        </div>
    </section>
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                <div class="card ">
                                    <a href="chi_tiet_sp.php" class="motsanpham"
                                        ...
                                        <img class="card-img-top anh" src="<?php echo $row['anh'] ? 'images/'.$row['anh'] : 'images/blog/giaotrinhtoan1.jpg';?>"
                                            alt="">
